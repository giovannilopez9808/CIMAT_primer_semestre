...
El programa que emplea los dos algoritmos esta contenida en la carpeta \textcolor{citecolor}{Problema\_4}. Los resultados de cada integral son los que se muestran en la tabla \ref{table:resultados4} y el programa arroja los resultados en la terminal como se muestra en la figura \ref{fig:resultados4}. Con estos resultados podemos obtener la diferencia entre los algoritmos, que es 0.157080.
\begin{table}[H]
    \centering
