...
El algoritmo de factorización de Cholesky se encuntra en la carpetas \folder{Problema\_3\_test} y \folder{Problema\_3\_1} en el archivo \file{Cholesky\_decomposition.h} en la función \script{obtain\_Cholesky}. La función es la siguiente:
