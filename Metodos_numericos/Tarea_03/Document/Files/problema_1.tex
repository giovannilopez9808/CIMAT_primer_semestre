...
\begin{table}[H]
    ...
    \begin{tabular}{lcll}
        \hline
        \multicolumn{1}{c}{\textbf{Ecuación}}       & \textbf{Valores} & \multicolumn{1}{c}{\textbf{\begin{tabular}[c]{@{}c@{}}Diferencia\\ absoluta\end{tabular}}} & \multicolumn{1}{c}{\textbf{\begin{tabular}[c]{@{}c@{}}Diferencia\\ Relativa\end{tabular}}}    \\ \hline
        \multirow{2}{*}{Ecuación \ref{eq:funcion1}} & $x_1$            & 0.000020                                               & 0.369004                                               \% \\
                                                    & $x_2$            & 0.009183                                               & 0.009953                                               \% \\
        \multirow{2}{*}{Ecuación \ref{eq:funcion2}} & $x_1$            & 0.009220                                               & 0.009994                                               \% \\
